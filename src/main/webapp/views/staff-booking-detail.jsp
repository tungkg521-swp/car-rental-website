                ...
                <div class="detail-info">
                    ...
                    <div class="specs">
                        ...
                        <div>
                            ...
                            <fmt:formatDate value="<%= booking.getBookingDate()%>" pattern="dd/MM/yyyy HH:mm"/>
                        </div>

                        <div>
                            <strong>Start Date:</strong>
                            <fmt:formatDate value="<%= booking.getStartDate()%>" pattern="dd/MM/yyyy"/>
                        </div>

                        <div>
                            <strong>End Date:</strong>
                            <fmt:formatDate value="<%= booking.getEndDate()%>" pattern="dd/MM/yyyy"/>
                        </div>

                        <div>
                            <strong>Total:</strong>
                            <fmt:formatNumber value="<%= booking.getTotalEstimatedPrice()%>" pattern="#,###"/> VND
                        </div>
            ...
            <div class="detail-description">
                ...
                <div class="info-grid">
                    ...
                    <div>
                        ...
                        <p>
                            <fmt:formatNumber value="<%= booking.getPricePerDay()%>" pattern="#,###"/> VND
                        </p>
                    </div>
